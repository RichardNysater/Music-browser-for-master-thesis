    ...
    function ($scope, Api, SongRequestService, PlaneService) {
      ...
      $scope.planeClick = function (event) {
        ...
        var xFeature = {
          ...
          minvalue: $scope.xpercent - $scope.feature_variance,
          maxvalue: $scope.xpercent + $scope.feature_variance
        };
        var yFeature = {
          feature: {id: $scope.secondSelect.id},
          minvalue: $scope.ypercent - $scope.feature_variance,
          maxvalue: $scope.ypercent + $scope.feature_variance
        };
